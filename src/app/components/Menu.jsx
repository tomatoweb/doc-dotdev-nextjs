...
export default function Menu() {
  ...
  return (
		...
		<div className={`bg-gray-800 lg:bg-black z-50 rounded-lg absolute lg:sticky lg:flex top-14 transition-all duration-500 ${sidebarState ? 'ml-0 w-full h-fit' : '-ml-[24rem] lg:ml-0'}`}>
