...
export default function TopNav() {
	...
	useEffect(() => {
		const media = window.matchMedia(`(max-width: 767px)`); // lg: 1023 or less
					...
					<div className="flex items-center justify-between w-full h-16 gap-0 sm:gap-3">
						...
						<div className="flex flex-row 3xl:flex-1 items-centers">
							<button
								...
								className={cn(
									'flex md:hidden active:scale-95 transition-transform lg:hidden w-12 h-12 rounded-full items-center justify-center hover:bg-primary/5 hover:dark:bg-primary-dark/5 outline-link',
									{
