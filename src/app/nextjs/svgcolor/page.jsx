...
`const Github = props => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="96" viewBox="0 0 98 96" {...props}>  
...
<Github width={60} height={60} className='text-tahiti' />
`;
...
const page = () => {
  return (
    <div>
      <Typography variant="h5" sx={{fontWeight: 600, marginBottom:4}}>SVG color prop</Typography>
      src/app/svg/Github.tsx
